...
`docs/casa-evidence/dependency-check/` (post-remediation, zero active
findings) and `docs/casa-evidence/dependency-check-before/` (original
scan, preserved as an audit trail):
