...
export const metadata: Metadata = {
  title: "Provenance Vehicles | VIN Verification & Ownership History",
  description:
    "Verify vehicle history, validate VINs, and track ownership provenance for cars, trucks, and motorcycles.",
  icons: {
    icon: "/favicon.svg",
        ...
        <nav className="sticky top-0 z-50 border-b border-wine/20 bg-parchment/95 backdrop-blur supports-[backdrop-filter]:bg-parchment/80">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
            <a href="/" className="font-cinzel text-xl font-bold tracking-wider text-wine">
              PROVENANCE <span className="text-sm font-normal tracking-wide">VEHICLES</span>
            </a>
            <div className="flex items-center gap-6 text-sm">
              <a href="/browse" className="text-ink/70 hover:text-ink transition-colors">Browse</a>
              <a href="/my" className="text-ink/70 hover:text-ink transition-colors">My Vehicles</a>
              <a href="/verify" className="text-ink/70 hover:text-ink transition-colors">Verify VIN</a>
            </div>
          </div>
        </nav>
        {children}
