...
const UsernamePasswordSignUpSchema = z
  .object({
    username: z.string()
...
type FormValues = z.infer<typeof UsernamePasswordSignUpSchema>;

export function UsernamePasswordSignUpForm({
  ...
  const form = useForm<FormValues>({
    resolver: zodResolver(UsernamePasswordSignUpSchema),
    defaultValues: {
      username: '',
      password: '',
      repeatPassword: '',
  ...
  return (
    <Form {...form}>
      ...
      >
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className={'text-xs'}>
                No email needed. You&apos;ll sign in with this username and your password.
              </FormDescription>
            </FormItem>
          )}
        />
        ...
        <Button
          data-test={'username-only-auth-submit-button'}
