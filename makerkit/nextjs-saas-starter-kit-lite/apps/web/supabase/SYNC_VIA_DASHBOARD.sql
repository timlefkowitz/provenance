...
-- ========== 20260507000000_entity_stats.sql ==========

/*
 * Aggregated rollup stats for galleries, artists, institutions, and collectors.
 * Required by the provenance valuation engine (computeValuationInputs).
 */
...
-- ========== 20260508000000_artwork_valuations.sql ==========

/*
 * Append-only provenance valuation history per artwork.
 * Required to save results from requestProvenanceValuation.
 */
