-- =============================================================================
-- SYNC VIA DASHBOARD (skips base schema — use when "accounts_read already exists")
-- =============================================================================
-- Your remote DB already has the base schema (20241219010757). This file runs
-- only the migrations AFTER that: from create_artworks through certificate_type.
-- Paste into Supabase Dashboard → SQL Editor → Run.
-- If you get "already exists" on a later section, run the next section only.
-- =============================================================================
